...
public class TListSentryPrivilegesByAuthRequest implements org.apache.thrift.TBase<TListSentryPrivilegesByAuthRequest, TListSentryPrivilegesByAuthRequest._Fields>, java.io.Serializable, Cloneable {
  ...
  public Set<TSentryAuthorizable> authorizableSet; // required
  public Set<String> groups; // optional
  public TSentryActiveRoleSet roleSet; // optional
  ...
  public TListSentryPrivilegesByAuthRequest setProtocol_version(int protocol_version) {
    this.protocol_version = protocol_version;
    setProtocol_versionIsSet(true);
    return this;
  }
  ...
  public TListSentryPrivilegesByAuthRequest setRequestorUserName(String requestorUserName) {
    this.requestorUserName = requestorUserName;
    return this;
  }
  ...
  public TListSentryPrivilegesByAuthRequest setAuthorizableSet(Set<TSentryAuthorizable> authorizableSet) {
    this.authorizableSet = authorizableSet;
    return this;
  }
  ...
  public TListSentryPrivilegesByAuthRequest setGroups(Set<String> groups) {
    this.groups = groups;
    return this;
  }
  ...
  public TListSentryPrivilegesByAuthRequest setRoleSet(TSentryActiveRoleSet roleSet) {
  ...
  public void validate() throws TException {
    ...
    if (authorizableSet == null) {
      throw new TProtocolException("Required field 'authorizableSet' was not present! Struct: " + toString());
    }
  ...
  private static class TListSentryPrivilegesByAuthRequestStandardScheme extends StandardScheme<TListSentryPrivilegesByAuthRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TListSentryPrivilegesByAuthRequest struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TListSentryPrivilegesByAuthRequest struct) throws TException {
      struct.validate();
  ...
  private static class TListSentryPrivilegesByAuthRequestTupleScheme extends TupleScheme<TListSentryPrivilegesByAuthRequest> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TListSentryPrivilegesByAuthRequest struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TListSentryPrivilegesByAuthRequest struct) throws TException {
