...
public class TRenamePrivilegesRequest implements org.apache.thrift.TBase<TRenamePrivilegesRequest, TRenamePrivilegesRequest._Fields>, java.io.Serializable, Cloneable {
  ...
  public TSentryAuthorizable oldAuthorizable; // required
  public TSentryAuthorizable newAuthorizable; // required
  ...
  public TRenamePrivilegesRequest setProtocol_version(int protocol_version) {
    this.protocol_version = protocol_version;
    setProtocol_versionIsSet(true);
    return this;
  }
  ...
  public TRenamePrivilegesRequest setRequestorUserName(String requestorUserName) {
    this.requestorUserName = requestorUserName;
    return this;
  }
  ...
  public TRenamePrivilegesRequest setOldAuthorizable(TSentryAuthorizable oldAuthorizable) {
    this.oldAuthorizable = oldAuthorizable;
    return this;
  }
  ...
  public TRenamePrivilegesRequest setNewAuthorizable(TSentryAuthorizable newAuthorizable) {
    this.newAuthorizable = newAuthorizable;
    return this;
  }
  ...
  public void validate() throws TException {
    ...
    if (oldAuthorizable == null) {
      throw new TProtocolException("Required field 'oldAuthorizable' was not present! Struct: " + toString());
    }
    if (newAuthorizable == null) {
      throw new TProtocolException("Required field 'newAuthorizable' was not present! Struct: " + toString());
    }
  ...
  private static class TRenamePrivilegesRequestStandardScheme extends StandardScheme<TRenamePrivilegesRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TRenamePrivilegesRequest struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRenamePrivilegesRequest struct) throws TException {
      struct.validate();
  ...
  private static class TRenamePrivilegesRequestTupleScheme extends TupleScheme<TRenamePrivilegesRequest> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TRenamePrivilegesRequest struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TRenamePrivilegesRequest struct) throws TException {
